...
const ResourcesPage = () => {
  ...
  return (
    <div className="space-y-8 dark:text-gray-100 relative">
      ...
      {/* Premium Header */}
      <div className="bg-gradient-to-br from-blue-500 via-indigo-500 to-indigo-700 rounded-3xl p-8 text-white shadow-lg relative overflow-hidden">
        <div className="relative z-10 space-y-3">
          <span className="bg-blue-600/30 px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider">
            ...
            return (
              ...
              >
                <div className="space-y-3">
                  <span className="inline-block bg-blue-50 dark:bg-blue-950/20 text-blue-700 dark:text-blue-400 text-xs font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                    {res.category}
                  </span>
                ...
                <div className="space-y-2 pt-2 border-t border-gray-50 dark:border-gray-700">
                  {isGoogleDrive && (
                    <button
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-xl text-xs md:text-sm transition-all flex items-center justify-center gap-1.5 shadow-sm active:scale-95"
                    >
                  ...
                  {res.external_url && (
                    <a
                      ...
                      className={`w-full font-bold py-2 px-4 rounded-xl text-xs md:text-sm transition-all flex items-center justify-center gap-1.5 active:scale-95 ${
                        isGoogleDrive 
                          ? 'border border-blue-500 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/20' 
                  ...
                  {res.file_path && !isGoogleDrive && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full border border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950/20 text-blue-600 dark:text-blue-400 font-bold py-2 px-4 rounded-xl text-xs md:text-sm transition-all flex items-center justify-center gap-1.5 active:scale-95"
                    >
                      📥 {t('resourceDownload')}
                    </a>
                  )}
