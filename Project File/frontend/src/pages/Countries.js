  ...
  return (
    <div className="dark:text-gray-100 relative">
      ...
      <p className="text-gray-500 dark:text-gray-400 mb-6">
        {lang === 'en' ? 'Browse and search countries where you can study abroad' : 'বিদেশে পড়াশোনা করার জন্য দেশসমূহ ব্রাউজ এবং অনুসন্ধান করুন'}
      </p>
            ...
            <div className="p-6 bg-gray-50 dark:bg-gray-900/80 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center shrink-0">
              {isAdmin && !isEditing && (
                <button
                  ...
                  className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-xl text-xs md:text-sm transition-all"
                >
