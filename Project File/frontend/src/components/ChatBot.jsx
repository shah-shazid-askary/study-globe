    ...
    <>
      ...
      {open && (
        <div
          ...
          className="fixed z-50 flex flex-col rounded-2xl shadow-2xl border border-gray-200 bg-white overflow-hidden transition-all duration-300 animate-in fade-in slide-in-from-bottom-4"
        >
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50">
            {messages.map((msg, i) => (
              ...
              >
                ...
                >
                  {msg.role === 'assistant' ? (
                    <div className="prose prose-sm max-w-none prose-p:my-1 prose-headings:text-blue-900 prose-headings:font-bold prose-a:text-blue-600 text-gray-800">
                      <ReactMarkdown 
